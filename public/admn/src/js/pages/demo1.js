...
function folded_menu_default() {
    if ($("body").hasClass("sidebar-left-hidden")) {
        ...
        $('#menu>li.dropdown_menu>a').on("click", function (e) {
            console.log('inside');
            return false;
        });
    } else {
...
function left_change() {
    console.log('inside left_change');
    setTimeout(function () {
        folded_menu_default();
    },300);
};
        ...
        if ($('#left').length) {
            $leftToggle.on(Admire.buttonPressedEvent, function (e) {
                ...
                if ($(window).width() < 768) {
                    ...
                    //console.log('unwanted else function');
...
//        Full screen
    ...
    if($(window).width()>767) {
        ...
        $(".toggle-left").on("click", function () {
            console.log('.toggle-left clicked');
            throughHamBurger = true;
            return false;
