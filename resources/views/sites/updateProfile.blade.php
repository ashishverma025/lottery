@include('users-dashboard/includes.head')
@include('users-dashboard/includes.sidebar')
        ...
        <div class="container-fluid add-student">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ !empty(@$userDetails) ? 'Update ' : 'Add ' }} Profile </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{url('lcstudents')}}" id="t_profile" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label> Email</label>
                                    <input type="email" id="email" name="email" class="form-control" value="{{ ($userDetails->email != '') ? $userDetails->email : ''}}" disabled>
                                ...
                                <div class="form-group">  <label>&nbsp;</label>
                                    <div class="row"><div class="col-md-4"><button type="button" id="edit_profile" userId ="<?= @$tutorId ?>" class="btn btn-primary">Save</button></div></div>
                                </div>
                            </div>
...
@include('users-dashboard/includes.footer')