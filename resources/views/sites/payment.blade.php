...
<input type="hidden" id="amount" value="{{ @$bettingDetails->winning_amount  }}">
<input type="hidden" id="quickBetId" value="">
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center subscribe-main-title  hide" id="successMsgdiv" >
    <h2 style="color:#01d1c0;">Thank you for subscribing with Tutify Cheers!</h2>
...
<div id="paymentForm" class="">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center subscribe-main-title">
        ...
        <p>Subscription Fee : ${{@$bettingDetails->winning_amount}} <br>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <script src="https://www.paypal.com/sdk/js?client-id=AeZz6puqQtD8o3IAPX4VXbzq3qf_4WFbCS0lSUTUyOwmWOiFDJVHOOk1kUeVAPqLnPtXFrP04YFayzip&currency=USD"></script>
        </div>
    </div>
    <!--@else-->
    <style>
        ...
        <div class="row ">
            ...
            <form role="form" name="payform" action="{{url('saveTransaction')}}" method="post" id="directPayment">
                ...
                <input type="hidden" name="amt" id="amount" value="{{ @$bettingDetails->winning_amount }}">
