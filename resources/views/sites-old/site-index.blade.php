...
<html lang="en">
    ...
    <head><meta https-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <!--<link href="{{ url('public/sites/users/css/font-awesome4.7.0.min.css') }}" rel="stylesheet">-->
    ...
    <body>
            ...
            <nav id="sticky-top" class="navbar navbar-default navbar-fixed-top custom-nav">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <div class="logo"> <a class="navbar-brand" href="#"><img src="{{ url('public/sites/images/logos.png') }}" alt="" class="img-responsive"></a> </div>
                    </div>
        ...
        <section class="banner-home">
            <div id="banner_home" class="owl-carousel owl-theme">
                <div class="item" style="background-image:url(public/sites/images/banner2.jpg);">
                    <!-- <img src="{{ url('public/sites/images/slider-img1.jpg') }}" alt="" class="img-responsive"> -->
                    <!---<div class="banner_title">
                        <div class="banner-title-img"> <img src="{{ url('public/sites/images/banner-title-shape.png') }}" alt="" class="img-responsive"> </div>
                ...
                <div class="item" style="background-image:url(public/sites/images/banner3.jpg);">
                    <!-- <img src="{{ url('public/sites/images/slider-img1.jpg') }}" alt="" class="img-responsive"> -->
                    <!---<div class="banner_title">
                       <div class="banner-title-img"> <img src="{{ url('public/sites/images/banner-title-shape.png') }}" alt="" class="img-responsive"> </div>
                       <a href="#" class="ctabtn">How It Works</a>
            ...
            <section class="banner-counter">
                <div class="container">
                    <ul class="user-counter-list">
                        <li><span class="icon"><i class="fa fa-user-o" aria-hidden="true"></i></span> <span>{{count($totalTutors)}} Tutors</span></li>
                ...
                <!--
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <div class="team_box">
                                            <div class="team_img">
                                                <img src="{{ url('public/sites/images/math-img.jpg') }}" alt="" class="img-responsive">
                                            </div>
                                            <div class="image-title">
                                                <h2>mathematics</h2>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="team_box">
                                            <div class="team_img">
                                                <img src="{{ url('public/sites/images/english.jpg') }}" alt="" class="img-responsive">
                                            </div>
                                            <div class="image-title">
                                                <h2>ENGLISH</h2>
                                            </div>
...
//                    pr($subject['subject_image']);
                    ...
                    <!--                    <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="team_box">
                                                <div class="team_img">
                                                    <img src="{{ url('public/sites/images/eco.jpg') }}" alt="" class="img-responsive">
                                                </div>
                                                <div class="image-title">
                                                    <h2>ECONOMICS</h2>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="team_box">
                                                <div class="team_img">
                                                    <img src="{{ url('public/sites/images/music.jpg') }}" alt="" class="img-responsive">
                                                </div>
                                                <div class="image-title">
                                                    <h2>MUSIC</h2>
                                                </div>
