            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="{{url('addsubjects')}}" id="update_attendance_table" class=" btn btn-primary"> Add Subject</a>
                        </div>
                                ...
                                <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Subject Status</th>
...
$(document).ready(function () {
    ...
    table.DataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": base_url + 'fetchsubjects',
        "columnDefs": [
