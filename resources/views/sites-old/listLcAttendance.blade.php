            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <form action="{{url('attendance')}}" id="filterForm" class="tuti-form profile-form" method="get" accept-charset="utf-8">
                            <div class="btn-group">
...
$(document).ready(function () {
    ...
    var url = base_url + 'fetchattendance';
//    console.log(queryString)
    if (queryString != "") {
        url = base_url + 'fetchattendance?' + queryString;
    }
    //	alert('jdsjsjd');
