...
<html lang="en">
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title>The-Spectrum-Classes|Home</title>
    ...
    <body>
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="logo">
                         <a class="navbar-brand" href="#">
                            <h3 style="color:whitesmoke">The Spectrum Classes</h3>
                            <!-- <img src="{{ asset('public/sites/images/logo.png') }}" alt="" class="img-responsive"> -->
                        </a> 
                        </div>
                    </div>
        ...
        <section class="banner-home">
            <div id="banner_home" class="owl-carousel owl-theme">
                <div class="item" style="background-image:url(public/sites/images/slider-img1.jpg);">
                    <!-- <img src="{{ asset('public/sites/images/slider-img1.jpg') }}" alt="" class="img-responsive"> -->
                    <div class="banner_title">
                        <div class="banner-title-img"> <img src="{{ asset('public/sites/images/banner-title-shape.png') }}" alt="" class="img-responsive"> </div>
                        <a href="#" class="ctabtn">How It Works</a>
                    </div>
                </div>
                <div class="item" style="background-image:url(public/sites/images/slider-img1.jpg);">
                    <!-- <img src="{{ asset('public/sites/images/slider-img1.jpg') }}" alt="" class="img-responsive"> -->
			...
			<div class="container">
			<ul class="user-counter-list">
			<li><span class="icon"><i class="fa fa-user-o" aria-hidden="true"></i></span> <span>12, 391 Tutors</span></li>
			<li><span class="icon"><i class="fa fa-users" aria-hidden="true"></i></span> <span>2, 443 Groups</span></li>
			<li><span class="icon"><i class="fa fa-briefcase" aria-hidden="true"></i></span> <span>8, 308 Requests</span></li>
			<li><span class="icon"><i class="fa fa-handshake-o" aria-hidden="true"></i></span> <span>6, 995 Engagenments </span></li>
			</ul>
			</div>
			</section>
                    ...
                    <form action="#" method="post" novalidate>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                                <div class="form-field">
                                    <input type="text" class="form-control search-slt" placeholder="Level & Subject">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 p-0">
                                <button type="button" class="btn wrn-btn search-btn"> <i class="fa fa-search" aria-hidden="true"></i> Search</button>
                            </div>
        ...
        <section class="services-sec">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-heading"> <img src="{{ asset('public/sites/images/title-before.png') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="ser-box">
                            <a href="#"><div class="icon-try-angle"><img src="{{ asset('public/sites/images/search-icon.png') }}" alt=""></div></a>
                            <div class="text-box">
                                <h2>SEARCH</h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="ser-box">
                            <a href="#"><div class="icon-try-angle"> <img src="{{ asset('public/sites/images/plain-icon.png') }}" alt=""> </div></a>
                            <div class="text-box">
                                <h2>REQUEST</h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="ser-box">
                            <a href="#"><div class="icon-try-angle"><img src="{{ asset('public/sites/images/assignment-icon.png') }}" alt=""></div></a>
                            <div class="text-box">
                                <h2>ASSIGNMENTS</h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="ser-box">
                            <a href="#"><div class="icon-try-angle"><img src="{{ asset('public/sites/images/resource-icon.png') }}" alt=""></div></a>
                            <div class="text-box">
                                <h2>RESOURCES</h2>
        ...
        <section class="video-section">
            <div id="video_banner" class="owl-carousel owl-theme">
                @if(!empty($Classvideos))
                @foreach($Classvideos as $key=>$videos)
                <div class="item">
                    <img src="{{ url('public/admin/upload/classvideo').'/'.$videos['image'] }}" alt="">
                    <div class="video_title">
                        <h2>LEARN ANYTIME</h2>
                        <p>See how tutify educators create a good learning eniournment for your child</p>
                        <div class="play-btn"><img src="{{ asset('public/sites/images/play-btn.png') }}" alt=""></div>
                    </div>
                ...
                @endif
<!--                <div class="item">
                    <img src="{{ asset('public/sites/images/video-banner.jpg') }}" alt="">
                    <div class="video_title">
                        <h2>LEARN ANYTIME</h2>
                        <p>See how tutify educators create a good learning eniournment for your child</p>
                        <div class="play-btn"><img src="{{ asset('public/sites/images/play-btn.png') }}" alt=""></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-heading">
                            <img src="{{ asset('public/sites/images/title-before.png') }}" alt="">
                            <h2>SEE ALL EXAM PAPERS</h2>
...
<!--                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/our-educator.jpg') }}" alt="" class="img-responsive">
                            </div>
                            <div class="price_tag">
                                <sub>$</sub>
                                <h3>35</h3>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/our-educator-2.jpg') }}" alt="" class="img-responsive">
                            </div>
                            <div class="price_tag">
                                <sub>$</sub>
                                <h3>35</h3>
                ...
                <div class="row">
                    ...
                    @foreach($practicePaper as $k=>$paper)
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="team_box">
                            <div class="team_img">
                                <a href="{{url('onlinePractice').'/'.$paper['paper_slug']}}"><img src="{{ url('public/admin/upload/papercover/').'/'.$paper['paper_cover_image'] }}" width="267" height="333" alt="{{$paper['paper_name']}}" class="img-responsivehh"></a>
                            </div>
                            <div class="price_tag">
                                <sub>$</sub>
                                <h3>35</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="see_all_btn">
                            <a href="{{url('onlinePractice')}}">SEE ALL PAPERS</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/math-img.jpg') }}" alt="" class="img-responsive">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/english.jpg') }}" alt="" class="img-responsive">
                            </div>
                            <div class="image-title">
                                <h2>ENGLISH</h2>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/chemistory.jpg') }}" alt="" class="img-responsive">
                            </div>
                            <div class="image-title">
                                <h2>chemistry</h2>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/eco.jpg') }}" alt="" class="img-responsive">
                            </div>
                            <div class="image-title">
                                <h2>ECONOMICS</h2>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="team_box">
                            <div class="team_img">
                                <img src="{{ asset('public/sites/images/music.jpg') }}" alt="" class="img-responsive">
                            </div>
                            <div class="image-title">
                                <h2>MUSIC</h2>
                            </div>
                            ...
                            <div id="socialSignup">
                                <div id="model1" class="model1">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="http://tutify.com.sg/home/g_sign_in" class="btn-google">
